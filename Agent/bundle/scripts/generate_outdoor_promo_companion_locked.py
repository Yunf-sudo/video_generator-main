...
BASE_REFERENCE_IMAGE = str(_bootstrap.LEGACY_ROOT / "pics" / "generated_4085aca1.png")
...
def main() -> None:
    ...
    report_path = ensure_active_run().exports / f"song_wheelchair_outdoor_promo_locked_{stamp}_report.json"
