...
def _resolve_scene_generation_context(scene_info: dict) -> dict:
    ...
    continuity_rider_anchor = (
        ...
        or "Keep exactly the same rider across connected scenes: same face, same hair, same body type, same skin tone, same wardrobe, same age impression, and the same wheelchair unless the user explicitly asks for a change."
    )
    return {
