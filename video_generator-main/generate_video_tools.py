...
VIDEO_DIR = "clips"
VIDEO_MODEL = os.getenv("VIDEO_MODEL", "veo_3_1-lite")
...
def _build_video_prompt(
    ...
    return apply_override(
        video_generate_prompt.format(info=json.dumps(payload, ensure_ascii=False)),
        "video_prompt_append",
    )
