...
PHOTO_MATCHED_STORYBOARD_PATHS = [
    "pics/generated_bef2bea2.png",
    "pics/generated_444a345d.png",
    "pics/generated_54b9f629.png",
    "pics/generated_603b1589.png",
]
...
def main() -> None:
    ...
    report_path = Path("exports") / f"song_wheelchair_outdoor_promo_western_photo_matched_remote_{stamp}_report.json"
