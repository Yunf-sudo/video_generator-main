...
STORYBOARD_PROBE_PATH = Path("exports") / "outdoor_promo_western_storyboard_probe.json"
...
def main() -> None:
    ...
    report_path = Path("exports") / f"song_wheelchair_outdoor_promo_western_{stamp}_report.json"
