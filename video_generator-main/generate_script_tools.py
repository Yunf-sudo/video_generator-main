...
def generate_scripts(params: dict) -> str:
    ...
    enriched_params.setdefault("product_visual_structure", get_product_visual_structure_json())
    user_prompt = apply_override(generate_script_user_prompt.format(**enriched_params), "script_user_append")
    messages = [
        {
            "role": "system",
