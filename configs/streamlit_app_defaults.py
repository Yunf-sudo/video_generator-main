...
DEFAULT_INPUTS = {
    ...
    "target_audience": "欧美市场的西方面孔外国老年男性、配偶、35-55 岁成年子女，以及正在为家人评估户外出行辅助产品的家庭；主角应自然状态、明显肥胖、heavyset、plus-size",
    ...
    "additional_info": "默认主角是完全同一位有尊严感、自然状态的肥胖或 plus-size 西方老年男性：同一张脸、同一发型、同一体型、同一肤色、同一套自然日常服装和同一年龄感。人物必须符合面向欧美市场的外国用户语境，优先使用西方面孔与欧美家庭生活环境，不要生成东亚面孔、中文本地化住宅语境或像国内街景的人物与场景。若出现配偶或家人，也要保持同样的外国成人家庭设定。不要换成女性、年轻人或普通体型人物，不要做成病态、夸张或不自然的表演感。保持姿态和身份稳定。如果是自驾，右手必须用大拇指和食指自然捏住右侧摇杆，不要变成握拳、平掌覆盖、手指悬空或放手滑行。优先保证轮椅主体清楚、路线简单可信，表现从家门口到院子再到公园的连续出行过程。不要额外添加参考图里没有的附件结构。",
